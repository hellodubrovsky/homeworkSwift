...
// MARK: Считаем для P == 2
for i in array {
    
    // P = 2, первому простому числу.
    // 1. p * 2
    // 2. p * 3
    // 3. p * 4
    
//    print(i)
    if let index = array.firstIndex(of: p * i) { array.remove(at: index) }
}
print("P=2-\(p)", array)



// MARK: Считаем для P == 3
p = 3
for i in array {
    
    // P = 3, первому незачеркнутому и не равного предыдущему (2) простому числу.
    // 1. p * 2
    // 2. p * 3
    // 3. p * 4
...
// MARK: Считаем для P == 5
p = 5
for i in array {
    
    // P = 5, первому незачеркнутому и не равного предыдущему (3) простому числу.
    // 1. p * 2
    // 2. p * 3
    // 3. p * 4
...
// MARK: Считаем для P == 7
p = 7
for i in array {
    
    // P = 7, первому незачеркнутому и не равного предыдущему (5) простому числу.
    // 1. p * 2
    // 2. p * 3
    // 3. p * 4
