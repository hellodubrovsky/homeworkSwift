...
//var primer = quadratic(a: 1, b: 12, c: 36)



//2. Даны катеты прямоугольного треугольника. Найти площадь, периметр и гипотенузу треугольника.

func triangle(a: Double, b: Double) -> [Character: Int] {
    ...
    if a > 0 && b > 0 {
        ...
        let p: Double = a + b + h
        print("Площадь равна \(Int(s)).\nПериметр равен \(Int(p)).\nГипотенуза равна \(Int(h)).")
        return["S": Int(s), "P": Int(p), "H": Int(h)]
    } else {
